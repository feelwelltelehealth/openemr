...
class CustomNewUserGrant extends PasswordGrant
{
    /**
    ...
    protected function validateUser(ServerRequestInterface $request, ClientEntityInterface $client)
    {
        ...
        $user = $this->userRepository->getCustomUserEntityByUsername(
            $userrole,
            $username,
            $email,
            $this->getIdentifier(),
        ...
        if ($user instanceof UserEntityInterface === false) {
            ...
            throw OAuthServerException::invalidGrant('Failed AuthenticationXX');
        }
